...
if prestacao > salario * 30 / 100:
    print(
        "Infelizmente não poderemos aprovar o seu financiamento, a prestação ultrapassa 30% do seu salário"
    )
#   print(prestacao, tempo, tempo2)
else:
    print("Parabens, seu emprestimo foi aprovado!")
    print(
        "O valor da sua prestação sera de {}, e você pagara em {} prestações.".format(
            prestacao, tempo2
        )
    )
